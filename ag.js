...
var consListStyles = {
  smaller: 'width: 260px; height:320px; margin-left: 2%; font-size: 15px;',
  between: 'width: 340px; height:320px; margin-left: -1%;'
};

var audListStyles = {
  smaller: 'width: 270px; height:320px;  margin-left: 2%; font-size: 15px;',
  between: 'width: 340px; height:320px; margin-left: -1%;'
};
...
// Define the styles for each element based on screen width
var env_svg_st = {
  between: 'margin-left: 50%; position:absolute;'
};
var env_svg_open_st = {
  between: 'margin-left: 80%;'
};
var tel_svg_st = {
  between: 'margin-left: 10%; top:30%;'
};
var tel_st = {
  between: 'margin-left: 5%; top:30%;'
};
var geo_st = {
  between: 'margin-left: 15%; top:30%;'
};
var mail_st = {
